package com.springboot.workers.springjdbc.model;
...
public class Worker implements Comparable<Worker> {
    ...
    public Worker(int workerID, String firstName, String lastName, int salary, Date joiningDate, String dept, String email,String password) {
        this.workerId = workerID;
        this.firstName = firstName;
        this.lastName = lastName;
        this.salary = salary;
